...
var useDebugState = function useDebugState(scopeContainer) {
  ...
  React__default["default"].useDebugValue([store, atoms], stateToPrintable);
};
    ...
    */
    React.useEffect(function () {
        if (React__default["default"].isValidElement(props.emojiPicker)) {
            setPicker(React__default["default"].cloneElement(props.emojiPicker, { onSelect: handleEmojiInsertion }));
        }
    }, [props.emojiPicker]);
    React.useEffect(function () {
        var timer = null;
    ...
    */
    ...
    return (React__default["default"].createElement("div", { className: "pn-msg-input pn-msg-input--".concat(theme, " ").concat(props.disabled ? "pn-msg-input--disabled" : "") },
        React__default["default"].createElement("div", { className: "pn-msg-input__wrapper" },
            ...
            React__default["default"].createElement("textarea", { className: "pn-msg-input__textarea", "data-testid": "message-input", disabled: props.disabled || !!file, onChange: function (e) { return handleInputChange(e); }, onKeyPress: function (e) { return handleKeyPress(e); }, placeholder: props.placeholder, ref: inputRef, rows: 1, value: text }),
...
var MessageList = function (props) {
    ...
    var bottomIntObserver = React.useRef(new IntersectionObserver(function (e) { return handleBottomIntersection(e[0].isIntersecting); }));
    /*
    /* Helper functions
    */
    ...
    */
    ...
    React.useEffect(function () {
        if (React__default["default"].isValidElement(props.reactionsPicker)) {
            setPicker(React__default["default"].cloneElement(props.reactionsPicker, { onSelect: handleEmojiInsertion }));
        }
    ...
    */
            ...
            React__default["default"].createElement("div", { className: "pn-msg__main" },
                React__default["default"].createElement("div", { className: "pn-msg__content" },
                    ...
                    (message === null || message === void 0 ? void 0 : message.text) &&
                        (props.bubbleRenderer && (props.filter ? props.filter(envelope) : true) ? (props.bubbleRenderer({ message: envelope, user: user, time: time, isOwn: isOwn, editedText: editedText })) : (React__default["default"].createElement("div", { className: "pn-msg__bubble" }, editedText || (message === null || message === void 0 ? void 0 : message.text))))),
    ...
    var renderFile = function (file) {
        return (React__default["default"].createElement("div", { className: "pn-msg__file" }, /\.(svg|gif|jpe?g|tiff?|png|webp|bmp)$/i.test(file.name) ? (React__default["default"].createElement("img", { alt: file.name, className: "pn-msg__image", src: file.url, onLoad: function () {
                if (scrolledBottom)
                    scrollToBottom();
    ...
    var renderAttachment = function (attachment, key) {
        var _a, _b, _c, _d, _e;
        return (React__default["default"].createElement("div", { key: key, className: "pn-msg__attachments" },
            attachment.type === "image" && (React__default["default"].createElement("img", { className: "pn-msg__image", src: (_a = attachment.image) === null || _a === void 0 ? void 0 : _a.source })),
            attachment.type === "link" && (React__default["default"].createElement("a", { className: "pn-msg__link", href: (_b = attachment.provider) === null || _b === void 0 ? void 0 : _b.url, target: "_blank", rel: "noreferrer noopener" },
                React__default["default"].createElement("img", { src: (_c = attachment.image) === null || _c === void 0 ? void 0 : _c.source }),
                React__default["default"].createElement("div", null,
                    React__default["default"].createElement("p", { className: "pn-msg__link-name" },
                        React__default["default"].createElement("img", { src: (_d = attachment.icon) === null || _d === void 0 ? void 0 : _d.source }), (_e = attachment.provider) === null || _e === void 0 ? void 0 :
                        _e.name),
